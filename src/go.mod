...
require (
	...
	github.com/gin-contrib/zap v1.1.3 // zap middleware for Gin
	github.com/gin-gonic/gin v1.10.0 // web framework
	github.com/go-redis/cache/v9 v9.0.0
	github.com/go-resty/resty/v2 v2.13.1 // rest client
	...
	github.com/stretchr/testify v1.9.0 // test framework, include assert, mock etc.
	gitlab.cdel.local/platform/go/platform-common v0.7.3
